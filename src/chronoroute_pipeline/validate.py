...
def validate_raw_month(service_type: str, year: int, month: int) -> dict[str, Any]:
    ...
    missing = required_source_columns(service, df.columns)
    if missing:
